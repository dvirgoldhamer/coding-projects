...
int main()
{
    ...
    Handleton<FileManager>::GetInstance()->AddFilePath("/home/dvir-goldhamer/git/projects/final_project/data3.bin");
    ...
    struct addrinfo* res;
    int sockfd = UDPFunctionality::CreateSocket("server", &res, RAIDManager::MINION3_IP_ADRRESS, RAIDManager::MINION3_PORT);
