...
int main()
{
    ...
    Handleton<FileManager>::GetInstance()->AddFilePath("/home/pi/data2.bin");
    ...
    struct addrinfo* res;
    int sockfd = UDPFunctionality::CreateSocket("server", &res, RAIDManager::MINION2_IP_ADRRESS, RAIDManager::MINION2_PORT);
